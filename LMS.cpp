...
#include<cmath>
using namespace std;
int counter=0;				//counter to count the registeration numbers 
int counter2=0;				//counter to count the courses added
int counter3=0;				//counter to count the students added
int r=0,c=0;
int counter4=0;
